...
import { getGroqChatResponse, ChatMessage } from '../services/aiService';
...
export const AIChatModal: React.FC<AIChatModalProps> = ({ isOpen, onClose, userName, role, className, dashboardData }) => {
  ...
  const handleSend = async (e?: React.FormEvent) => {
    ...
    const result = await getGroqChatResponse(updatedMessages, language, { userName, role, className, liveData });
           ...
           <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                 ...
                 <p className="text-[8px] font-bold text-slate-400 uppercase tracking-widest flex items-center gap-1">
                    <Sparkles size={8} className="text-emerald-500" /> Powered by Groq
                 </p>
              </div>
           </div>
